...
var ownCar2 = (BasicCar)Activator.CreateInstance(typeof(BasicCar), transmission, (Body)variant5 - 1, engine, (Mark)variant - 1, (Model)variant2 - 1, (Color)variant3 - 1);

//Console.WriteLine();
//ownCar.WriteToFileAndConsole();
ownCar2.StartEngine(engine);
